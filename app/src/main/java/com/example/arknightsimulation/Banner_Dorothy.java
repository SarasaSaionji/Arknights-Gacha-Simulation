...
public class Banner_Dorothy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_banner_dorothy);
        ...
        Gacha_10Time.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (currentOrundum >= 6000) {
                    ...
                    Toast.makeText(Banner_Dorothy.this, "Not Enought Orundum", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void Random_10TimeGacha() {
        ...
        //rate up
        String[] SixsStarRateup_Arknight = {"Dorothy"};
        String[] FivesStarRateup_Arknight = {"RockRock","Greyy the Lightning"};
