...
public class Banner_Nearl_Radiant extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_banner_nearl_radiant);
        ...
        Gacha_10Time.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (currentOrundum >= 6000) {
                    ...
                    Toast.makeText(Banner_Nearl_Radiant.this, "Not Enought Orundum", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void Random_10TimeGacha() {
        ...
        //rate up
        String[] SixsStarRateup_Arknight = {"Nearl the Radiant","Flametail"};
        String[] FivesStarRateup_Arknight = {"Corroserum"};
        ...
        String[] SixsStar_Arknight = {"Weedy", "Thorns", "Eunectes", "Surtr", "Blemishine", "Mudrock",
                ...
                "Swire the Elegant Wit","W","Rosmontis"};
